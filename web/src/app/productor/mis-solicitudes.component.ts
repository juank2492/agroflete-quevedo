...
import type { Solicitud } from '@agroflete/shared';
...
@Component({
  ...
  imports: [RouterLink, DatePipe, DecimalPipe, TitleCasePipe, IconComponent, EstadoBadgeComponent],
        ...
        <ul class="mt-6 space-y-3">
          @for (s of solicitudes(); track s.id) {
            <li>
              ...
              >
                <div class="flex items-center justify-between">
                  <span class="font-semibold">{{ s.cultivo | titlecase }} · {{ s.pesoTon }} t</span>
