...
@Component({
  selector: 'app-transportista-shell',
  ...
  template: `
    <div class="flex min-h-screen flex-col bg-base-200">
      ...
      >
        <a routerLink="/t" class="flex items-center gap-2 font-display font-bold">
      ...
      >
        ...
        >
          ...
          <span class="text-xs">Fletes</span>
        </a>
        <a
          routerLink="/t/vehiculo"
          routerLinkActive="text-primary"
          class="flex flex-col items-center gap-1 py-2 text-base-content/70"
        >
          <app-icon name="route" [size]="20" />
          <span class="text-xs">Vehículo</span>
        </a>
      </nav>
    </div>
  `,
})
export class TransportistaShellComponent {
